...
<html lang="fr-FR">
    <head>
        ...
        <meta name="description" content="Possibilité d'envoyer un message après avoir donné plusieurs informations.">
    ...
    <body>
        ...
        <section id="carto">
            ...
            <img src="https://www.mapquestapi.com/staticmap/v5/map?key=bZNXQieHCY65xphzmzAPLTH1EQSKUDq0&locations=Toulon,Var,France|http://gil83.fr/nolark/marqueur_nolark.png&center=Chateauroux,Indre,France&zoom=6&size=590,610" alt="Carte OpenStreetMap statique avec le pays de Nolark">
